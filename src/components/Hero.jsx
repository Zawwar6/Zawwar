...
>
  ...
  {/* RIGHT (Circle) */}
  <div ref={imgRef} className="w-full lg:w-1/2 flex justify-center items-center mt-10 lg:mt-0">
    <div className="relative w-56 h-56 sm:w-72 sm:h-72 lg:w-80 lg:h-80 rounded-full flex items-center justify-center bg-gradient-to-r from-indigo-400/20 via-sky-400/20 to-teal-300/20 backdrop-blur">
      <h2 className="absolute text-base sm:text-lg lg:text-xl font-semibold text-cyan-200">
        Tech Stack ⚡
      </h2>
      <div className="absolute inset-0 animate-spin-slow flex items-center justify-center">
        <img src="/1.png" alt="React" className="stack-logo w-10 h-10 sm:w-12 sm:h-12 absolute top-0" />
        <img src="/2.png" alt="Node.js" className="stack-logo w-10 h-10 sm:w-12 sm:h-12 absolute right-0" />
        <img src="/3.png" alt="MongoDB" className="stack-logo w-10 h-10 sm:w-12 sm:h-12 absolute bottom-0" />
        <img src="/4.png" alt="Express" className="stack-logo w-10 h-10 sm:w-12 sm:h-12 absolute left-0" />
      </div>
    </div>
  </div>
</section>
